...
| `COMMAND_OPERATION_RETENTION_DAYS` | optional (has defaults) | non-secret | Retains ordinary command-ledger rows for 180 days by default; uncertain and unresolved rows are preserved. | code | netlify/functions/cleanup-scheduled.ts:19 |
