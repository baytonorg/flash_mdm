    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {filters.map((filter) => (
        <select
          ...
          className="min-w-0 rounded-lg border border-border bg-surface px-3 py-2 text-sm text-gray-700 focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20"
        >
